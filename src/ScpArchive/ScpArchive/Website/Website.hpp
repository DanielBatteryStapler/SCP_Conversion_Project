...
class Website{
	...
	private:
        ...
        static bool handleFormattedArticle(Gateway::RequestContext& reqCon, Website::Context& webCon, std::string pageName, Database::ID pageId, std::map<std::string, std::string> parameters, Database::PageRevision& revision);
};
